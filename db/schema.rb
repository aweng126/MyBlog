...
ActiveRecord::Schema.define(version: 20170520110706) do
  ...
  create_table "classifies_posts", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
