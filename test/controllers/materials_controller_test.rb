...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { name: @material.name, tlink: @material.tlink } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { name: @material.name, tlink: @material.tlink } }
